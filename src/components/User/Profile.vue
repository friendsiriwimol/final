...
<v-card class="cardShowuser">
    ...
    <div class="ma-10">
    <v-row >ชื่อ : สิริวิมล</v-row>
    <v-row >นามสกุล : เพชรเวียง</v-row>
    <v-row >อีเมล : friend.siriwimol@kkumail.com</v-row>
    <v-row >เบอร์โทร : 0943706163</v-row>
    <v-row >อายุ : 21</v-row>
        <v-row >กลุ่มผู้ใช้งาน : นักศึกษา</v-row>
        </div>
        </v-card-text>
    <!-- <v-virtual-scroll
      :items="items"
